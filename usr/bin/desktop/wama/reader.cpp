...
int ver2(char *contenido)
{
    ...
    vga[1923] = VGA_CHAR('E', BLACK, BROWN);
    vga[1924] = VGA_CHAR(']', BLACK, BROWN);
    vga[1925] = VGA_CHAR(' ', BLACK, BROWN);
    vga[1926] = VGA_CHAR('E', BLACK, BROWN);
    vga[1927] = VGA_CHAR('n', BLACK, BROWN);
    vga[1928] = VGA_CHAR('t', BLACK, BROWN);
    vga[1929] = VGA_CHAR('e', BLACK, BROWN);
    vga[1930] = VGA_CHAR('r', BLACK, BROWN);
    vga[1931] = VGA_CHAR(' ', BLACK, BROWN);
    vga[1932] = VGA_CHAR(' ', BLACK, BROWN);
    for (i=1933; i < 2000; i++) {
