...
int errorescritura()
{
    ...
    vga[993] = VGA_CHAR('O', BLACK, RED);
    vga[994] = VGA_CHAR('p', BLACK, RED);
    vga[995] = VGA_CHAR('e', BLACK, RED);
    vga[996] = VGA_CHAR('n', BLACK, RED);
    vga[997] = VGA_CHAR('i', BLACK, RED);
    vga[998] = VGA_CHAR('n', BLACK, RED);
    vga[999] = VGA_CHAR('g', BLACK, RED);
    vga[1000] = VGA_CHAR(' ', BLACK, RED);
    vga[1001] = VGA_CHAR('t', BLACK, RED);
    vga[1002] = VGA_CHAR('h', BLACK, RED);
    vga[1003] = VGA_CHAR('e', BLACK, RED);
    vga[1004] = VGA_CHAR(' ', BLACK, RED);
    vga[1005] = VGA_CHAR('f', BLACK, RED);
    vga[1006] = VGA_CHAR('i', BLACK, RED);
    vga[1007] = VGA_CHAR('l', BLACK, RED);
    vga[1008] = VGA_CHAR('e', BLACK, RED);
    ...
    vga[1076] = VGA_CHAR('E', BLACK, RED);
    vga[1077] = VGA_CHAR('n', BLACK, RED);
    vga[1078] = VGA_CHAR('t', BLACK, RED);
    vga[1079] = VGA_CHAR('e', BLACK, RED);
    vga[1080] = VGA_CHAR('r', BLACK, RED);
    vga[1081] = VGA_CHAR(' ', BLACK, RED);
    vga[1082] = VGA_CHAR('(', BLACK, RED);
    vga[1083] = VGA_CHAR('E', BLACK, RED);
    vga[1084] = VGA_CHAR(')', BLACK, RED);
...
int nuevo()
{
    ...
    printf("\r\n");
    printf("Type exit to close the text editor\r\n");
    do {
      gets(linea);
...
int infosave()
{
    ...
    vga[998] = VGA_CHAR('S', BLACK, RED);
    vga[999] = VGA_CHAR('a', BLACK, RED);
    vga[1000] = VGA_CHAR('v', BLACK, RED);
    vga[1001] = VGA_CHAR('e', BLACK, RED);
    vga[1002] = VGA_CHAR('d', BLACK, RED);
    vga[1003] = VGA_CHAR(' ', BLACK, RED);
    vga[1004] = VGA_CHAR(' ', BLACK, RED);
    vga[1005] = VGA_CHAR(' ', BLACK, RED);
