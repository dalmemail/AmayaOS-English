...
int wama()
{
    ...
    vga[1922] = VGA_CHAR('S', BLACK, BROWN);
    vga[1923] = VGA_CHAR(']', BLACK, BROWN);
    vga[1924] = VGA_CHAR(' ', BLACK, BROWN);
    vga[1925] = VGA_CHAR('S', BLACK, BROWN);
    vga[1926] = VGA_CHAR('e', BLACK, BROWN);
    vga[1927] = VGA_CHAR('e', BLACK, BROWN);
    vga[1928] = VGA_CHAR(' ', BLACK, BROWN);
    vga[1929] = VGA_CHAR('a', BLACK, BROWN);
    vga[1930] = VGA_CHAR(' ', BLACK, BROWN);
    vga[1931] = VGA_CHAR('f', BLACK, BROWN);
    vga[1932] = VGA_CHAR('i', BLACK, BROWN);
    vga[1933] = VGA_CHAR('l', BLACK, BROWN);
    vga[1934] = VGA_CHAR('e', BLACK, BROWN);
    vga[1935] = VGA_CHAR(' ', BLACK, BROWN);
    ...
    vga[1942] = VGA_CHAR('e', BLACK, BROWN);
    vga[1943] = VGA_CHAR('w', BLACK, BROWN);
    vga[1944] = VGA_CHAR(' ', BLACK, BROWN);
    vga[1945] = VGA_CHAR('f', BLACK, BROWN);
    vga[1946] = VGA_CHAR('i', BLACK, BROWN);
    vga[1947] = VGA_CHAR('l', BLACK, BROWN);
    vga[1948] = VGA_CHAR('e', BLACK, BROWN);
    vga[1949] = VGA_CHAR(' ', BLACK, BROWN);
    vga[1950] = VGA_CHAR(' ', BLACK, BROWN);
    vga[1951] = VGA_CHAR(' ', BLACK, BROWN);
    vga[1952] = VGA_CHAR(' ', BLACK, BROWN);
    vga[1953] = VGA_CHAR(' ', BLACK, BROWN);
    ...
    vga[1961] = VGA_CHAR(' ', BLACK, BROWN);
    vga[1962] = VGA_CHAR('a', BLACK, BROWN);
    vga[1963] = VGA_CHAR(' ', BLACK, BROWN);
    vga[1964] = VGA_CHAR('f', BLACK, BROWN);
    vga[1965] = VGA_CHAR('i', BLACK, BROWN);
    vga[1966] = VGA_CHAR('l', BLACK, BROWN);
    vga[1967] = VGA_CHAR('e', BLACK, BROWN);
    vga[1968] = VGA_CHAR(' ', BLACK, BROWN);
    vga[1969] = VGA_CHAR(' ', BLACK, BROWN);
    vga[1970] = VGA_CHAR(' ', BLACK, BROWN);
    vga[1971] = VGA_CHAR(' ', BLACK, BROWN);
    vga[1972] = VGA_CHAR('[', BLACK, BROWN);
    vga[1973] = VGA_CHAR('C', BLACK, BROWN);
    vga[1974] = VGA_CHAR(']', BLACK, BROWN);
    vga[1975] = VGA_CHAR(' ', BLACK, BROWN);
    vga[1976] = VGA_CHAR('E', BLACK, BROWN);
    vga[1977] = VGA_CHAR('x', BLACK, BROWN);
    vga[1978] = VGA_CHAR('i', BLACK, BROWN);
    vga[1979] = VGA_CHAR('t', BLACK, BROWN);
    vga[1980] = VGA_CHAR(' ', BLACK, BROWN);
    ...
    do {
      tecla = getchar();
             ...
             && tecla != 'C'&& tecla != 'c'&& tecla != 'S'&& tecla != 's'&& tecla != 'I'&& tecla != 'i');
    if (tecla == 'C'|| tecla == 'c') {
      int argc;
      char **argv;
      main(argc, argv);
...
int info()
{
    ...
    vga[166] = VGA_CHAR('W', BLACK, BLUE);
    vga[167] = VGA_CHAR('A', BLACK, BLUE);
    vga[168] = VGA_CHAR('+', BLACK, BLUE);
    vga[169] = VGA_CHAR(')', BLACK, BLUE);
    vga[170] = VGA_CHAR('i', BLACK, BLUE);
    vga[171] = VGA_CHAR('s', BLACK, BLUE);
    vga[172] = VGA_CHAR(' ', BLACK, BLUE);
    vga[173] = VGA_CHAR('a', BLACK, BLUE);
    vga[174] = VGA_CHAR(' ', BLACK, BLUE);
    vga[175] = VGA_CHAR('t', BLACK, BLUE);
    vga[176] = VGA_CHAR('e', BLACK, BLUE);
    vga[177] = VGA_CHAR('x', BLACK, BLUE);
    vga[178] = VGA_CHAR('t', BLACK, BLUE);
    vga[179] = VGA_CHAR(' ', BLACK, BLUE);
    vga[180] = VGA_CHAR('e', BLACK, BLUE);
    vga[181] = VGA_CHAR('d', BLACK, BLUE);
    vga[182] = VGA_CHAR('i', BLACK, BLUE);
    vga[183] = VGA_CHAR('t', BLACK, BLUE);
    vga[184] = VGA_CHAR('o', BLACK, BLUE);
    vga[185] = VGA_CHAR('r', BLACK, BLUE);
    vga[186] = VGA_CHAR(' ', BLACK, BLUE);
    vga[187] = VGA_CHAR('i', BLACK, BLUE);
    vga[188] = VGA_CHAR('n', BLACK, BLUE);
    vga[189] = VGA_CHAR('s', BLACK, BLUE);
    vga[190] = VGA_CHAR('p', BLACK, BLUE);
    vga[191] = VGA_CHAR('i', BLACK, BLUE);
    vga[192] = VGA_CHAR('r', BLACK, BLUE);
    vga[193] = VGA_CHAR('e', BLACK, BLUE);
    vga[194] = VGA_CHAR('d', BLACK, BLUE);
    vga[195] = VGA_CHAR(' ', BLACK, BLUE);
    vga[196] = VGA_CHAR('o', BLACK, BLUE);
    vga[197] = VGA_CHAR('n', BLACK, BLUE);
    vga[198] = VGA_CHAR(' ', BLACK, BLUE);
    vga[199] = VGA_CHAR('G', BLACK, BLUE);
    vga[200] = VGA_CHAR('N', BLACK, BLUE);
    vga[201] = VGA_CHAR('U', BLACK, BLUE);
    vga[202] = VGA_CHAR(' ', BLACK, BLUE);
    vga[203] = VGA_CHAR('E', BLACK, BLUE);
    vga[204] = VGA_CHAR('m', BLACK, BLUE);
    vga[205] = VGA_CHAR('a', BLACK, BLUE);
    vga[206] = VGA_CHAR('c', BLACK, BLUE);
    vga[207] = VGA_CHAR('s', BLACK, BLUE);
    vga[208] = VGA_CHAR('.', BLACK, BLUE);
    vga[209] = VGA_CHAR(' ', BLACK, BLUE);
    vga[210] = VGA_CHAR('V', BLACK, BLUE);
    vga[211] = VGA_CHAR('e', BLACK, BLUE);
    vga[212] = VGA_CHAR('r', BLACK, BLUE);
    vga[213] = VGA_CHAR('s', BLACK, BLUE);
    vga[214] = VGA_CHAR('i', BLACK, BLUE);
    vga[215] = VGA_CHAR('o', BLACK, BLUE);
    vga[216] = VGA_CHAR('n', BLACK, BLUE);
    vga[217] = VGA_CHAR(' ', BLACK, BLUE);
    vga[218] = VGA_CHAR('0', BLACK, BLUE);
    vga[219] = VGA_CHAR('.', BLACK, BLUE);
    vga[220] = VGA_CHAR('2', BLACK, BLUE);
    vga[221] = VGA_CHAR(' ', BLACK, BLUE);
    vga[222] = VGA_CHAR(' ', BLACK, BLUE);
    vga[223] = VGA_CHAR(' ', BLACK, BLUE);
    vga[224] = VGA_CHAR(' ', BLACK, BLUE);
    vga[225] = VGA_CHAR(' ', BLACK, BLUE);
    vga[226] = VGA_CHAR(' ', BLACK, BLUE);
    vga[227] = VGA_CHAR(' ', BLACK, BLUE);
    vga[228] = VGA_CHAR(' ', BLACK, BLUE);
    vga[229] = VGA_CHAR(' ', BLACK, BLUE);
    vga[230] = VGA_CHAR(' ', BLACK, BLUE);
    vga[231] = VGA_CHAR(' ', BLACK, BLUE);
    vga[232] = VGA_CHAR(' ', BLACK, BLUE);
    vga[233] = VGA_CHAR(' ', BLACK, BLUE);
    vga[234] = VGA_CHAR(' ', BLACK, BLUE);
    ...
    vga[1920] = VGA_CHAR('[', BLACK, BROWN);
    vga[1921] = VGA_CHAR('E', BLACK, BROWN);
    vga[1922] = VGA_CHAR(']', BLACK, BROWN);
    vga[1923] = VGA_CHAR(' ', BLACK, BROWN);
    vga[1924] = VGA_CHAR('E', BLACK, BROWN);
    vga[1925] = VGA_CHAR('n', BLACK, BROWN);
    vga[1926] = VGA_CHAR('t', BLACK, BROWN);
    vga[1927] = VGA_CHAR('e', BLACK, BROWN);
    vga[1928] = VGA_CHAR('r', BLACK, BROWN);
    vga[1929] = VGA_CHAR(' ', BLACK, BROWN);
    vga[1930] = VGA_CHAR(' ', BLACK, BROWN);
    for (i=1931; i < 2000; i++) {
...
int editar()
{
    ...
    /* Point to the VGA mapping. */
    vga = (u16 *) mem.virtualAddress;
    printf("Enter the name of a file to be edited: ");
    gets(nombre);
    if (nombre[0] == '/') {
      strcpy(ruta, nombre);
    }
